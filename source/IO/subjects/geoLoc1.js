    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            function updateMarkers() {
                if (map && scope.markers) {
                    ...
                    for (var i = 0; i < markers.length; i++) {
                        ...
                        var mm = new google.maps.Marker({ position: loc, map: map, title: m.name,animation:google.maps.Animation.BOUNCE });
            ...
            function getLocation(loc) {
                if (loc == null) return new google.maps.LatLng(6.9271, 79.8612);
